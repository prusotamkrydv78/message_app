...
const UserPlus = dynamic(() => import("lucide-react").then(m => m.UserPlus), { ssr: false });
...
const PhoneCall = dynamic(() => import("lucide-react").then(m => m.PhoneCall), { ssr: false });
const Video = dynamic(() => import("lucide-react").then(m => m.Video), { ssr: false });
